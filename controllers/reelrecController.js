...
exports.getUserById = async (req, res) => {
  try {
    const user = await ReelRec.findOne({ uid: req.params.userId });
...
exports.updateUser = async (req, res) => {
  try {
    const updatedUser = await ReelRec.findOneAndUpdate({ uid: req.params.userId }, req.body, { new: true });
...
exports.deleteUser = async (req, res) => {
  try {
    const deletedUser = await ReelRec.findOneAndDelete({ uid: req.params.userId });
